...
exports.products_post = (req,res) => {
    try {
        ...
        const {name, description,subDescription, price,marketPrice, seller,imageUrl, imageUrl2, imageUrl3, imageUrl4,imageUrl5, detailPage1, detailPage2,detailPage3,detailPage4,detailPage5, sizeDesc} = req.body;
        ...
        // //product 한개만 생성 
        db.Product.create({
            name,price,marketPrice,seller,description,subDescription,imageUrl, imageUrl2, imageUrl3, imageUrl4,imageUrl5, detailPage1,detailPage2,detailPage3,detailPage4,detailPage5,sizeDesc
        })
        .then((result)=>{
            res.send({
                result,
